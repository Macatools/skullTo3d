...
def automatic_threshold(img_file):
    import os
    import numpy as np
    ...
    ## Import of the MRI image
    # CENIR
    #img_file = '/envau/work/nit/users/sghari.a/AutomaticThreshold/sub-Darwin_PDw_flirt_res_masked_restore.nii.gz'
    # CERIMED
    #img_file = '/envau/work/nit/users/sghari.a/AutomaticThreshold/sub-Ebdo_ses-01_rec-mean_petra_roi_restore_masked.nii.gz'
    ...
    ## We must define : 
        ## 
        ## the minimum of the second group for the headmask
        ## and the mean of the second group for the skull extraction
    ...
    ## Print the maximum value of three groups
    #print("\namax_Group 1:", np.amax(groups[0]))
    #print("amax_Group 2:", np.amax(groups[1]))
    #print("amax_Group 3:", np.amax(groups[2]))
    print("headmask_threshold : ",headmask_threshold)
    print("skull_extraction_threshold : ",skull_extraction_threshold)
    
    return headmask_threshold, skull_extraction_threshold
